...
<form name=ShopForm method="POST" action="https://demomoney.yandex.ru/eshop.xml">
	...
	ФИО Плательщика:<br> <input type=text name="CustomerNumber" size="43"><br><br>
	Сумма:<br><input type=text name="Sum" size="43"><br><br>
	Команда:<br><input type="text" name="teamName" value="<?= $teamName ?>" disabled="disabled"><br><br> Способ
	оплаты:<br><br> <input name="paymentType" value="PC" type="radio" checked="checked" />Со счета в
