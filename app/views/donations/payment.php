...
<form name=ShopForm method="POST" action="https://demomoney.yandex.ru/eshop.xml">
	...
	Сумма:<br><input type=text name="Sum" size="43" required="required"><br><br> Команда:<br><input type="text" name="teamName" value="<?= $teamName ?>" disabled="disabled"><br><br> Способ
