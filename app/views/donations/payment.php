...
<form name=ShopForm method="POST" action="https://demomoney.yandex.ru/eshop.xml">
	...
	Команда:<br><input type="text" name="teamName" value="<?= $teamName ?>"><br><br> Способ оплаты:<br><br> <input name="paymentType" value="PC" type="radio" checked="checked" />Со счета в
